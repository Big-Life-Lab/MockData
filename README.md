...
[GitHub Discussion #31](https://github.com/Big-Life-Lab/MockData/discussions/31).
...
MockData is used to test data analysis pipelines, including data transformation, cleaning, analysis, and modelling. For example, MockData allows you to create out-of-range and invalid data (what we call "garbage" data) to test data cleaning processes.
