...
variables <- read.csv(system.file("extdata/cchs/cchsflow_sample_variables.csv", package = "MockData"),
                     header = T, check.names=FALSE, na.strings=c("","NA","N/A"))
# CCHS sample variable details from cchsflow
variable_details <- read.csv(system.file("extdata/cchs/cchsflow_sample_variable_details.csv", package = "MockData"),
                              header = T, check.names=FALSE, na.strings=c("","NA","N/A"))
```
