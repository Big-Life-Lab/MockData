...
This tutorial introduces temporal data generation concepts. For complete working examples, see the [DemPoRT example](demport-example.html).
:::
...
For complete production-ready examples with survival analysis, see the [DemPoRT example](demport-example.html).
