...
This reference document provides comprehensive technical specifications for date variable generation. For step-by-step tutorials, see [Working with date variables](tutorial-dates.html).
:::
