...
#| include: false
stopifnot(
  "adding a survival date leaves baseline values unchanged" = generated_x_unchanged,
  "a survival date drawn earlier changes later survival dates" = death_changed_before > 0,
  "a survival date drawn later leaves earlier ones unchanged" = death_changed_after == 0,
