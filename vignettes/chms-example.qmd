...
All numeric values shown in this vignette are computed from the actual CHMS sample metadata files. Code is hidden by default for readability, but you can view the source `.qmd` file to see how values are calculated.
:::
...
variables <- read.csv(
  "../inst/extdata/chms/variables_chmsflow_sample.csv",
  header = TRUE,
  check.names = FALSE,
  na.strings = c("", "NA", "N/A"),
...
variable_details <- read.csv(
  "../inst/extdata/chms/variable_details_chmsflow_sample.csv",
  header = TRUE,
  check.names = FALSE,
  na.strings = c("", "NA", "N/A"),
  stringsAsFactors = FALSE
