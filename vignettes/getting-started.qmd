...
This introductory tutorial teaches core MockData concepts through progressive examples. All code runs during vignette build to ensure accuracy.
:::
...
MockData uses recodeflow metadata (variable definitions and recode rules) to generate data that mimics the structure and distributions of real health survey datasets like the Canadian Community Health Survey (CCHS) and the Canadian Health Measures Survey (CHMS).
